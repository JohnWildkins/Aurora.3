...
var/global/list/minevendor_list = list( //keep in order of price
	...
	new /datum/data/mining_equipment("Minecart",					/obj/vehicle/train/trolley/mining,					-1,					600,	1),
	...
	new /datum/data/mining_equipment("Minecart Engine",				/obj/vehicle/train/engine/mining,						-1,					800,	1),
